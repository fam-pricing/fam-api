...
15. NO WORKAROUND/ALTERNATIVE PARROT — Look at the previous Bot messages. If the bot already suggested a specific workaround, alternative link, or redirect (e.g. "check our other Upside Living listings", "see our Marina options", "browse our full portfolio on propertyfinder.ae", "I can send you other 2BR options") and the draft suggests THE SAME alternative or link again — FAIL. Leads notice when the bot gives the same workaround reply twice. If the lead is asking again about the same topic after the bot already redirected them, answer the specific NEW question (if any) directly, or escalate by saying a human will reach out. Do not loop on the same canned alternative. Example FAIL: bot previously said "Please check our other Upside Living listings here: [link]" and the draft says "You can browse our other Upside Living options at [link]" — same redirect, different words, still a FAIL.
