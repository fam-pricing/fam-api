...
## Learned (2026-04-01) — CLEANUP NOTE
2026-04-01 — Removed 2 junk entries generated by the now-fixed escalation Q&A learning bug. Entries were bot-internal escalation reasons (not real lead questions) paired with specific portfolio answers (with URLs and AED prices). These are never reusable as general rules. Bug fixed: last_escalated_question is now always null; paused-bot learning rejects replies with URLs, >300 chars, or specific prices.

## Learned (2026-04-04)
- When a lead asks when they can expect a price change, respond:
...
## Learned (2026-04-06)
- When a lead confirms they want to view the property but does not specify an exact time, respond as follows:
...
## Learned (2026-04-08)
- If a lead says: "It will be through bank account" → Reply: "Attachment"
  (Learned from Faysal handling Raha re https://www.propertyfinder.ae/en/plp/rent/apartment-for-rent-dubai-business-bay-upside-living-2PSudOeqYWO.html)
...
## Learned (2026-05-07)
- When a lead says they need to check with their husband about viewing today or tomorrow, respond by informing them that viewings are available daily from 9:00 AM to 6:00 PM.
  (Learned from Faysal handling yassmeenelshreef re https://www.propertyfinder.ae/en/plp/rent/apartment-for-rent-dubai-business-bay-elite-business-bay-residence-13851920.html)

## Learned (2026-05-08)
- When a lead asks "Can I book?" or expresses intent to book, reply with:

"To confirm your booking, please send us the following:
...
## Learned (2026-05-13)
- When a lead asks for full pricing information before committing, respond with the following:
